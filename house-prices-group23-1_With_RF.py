...
# MAGIC 
# MAGIC * We can obseve the columns BedroomAbvGr, ScreenPorch, PoolArea, MoSold, 3SsnPorch BsmtFinSF2, BsmtHalfBath , MiscVal , LowQualFinSF, YrSold, OverallCond, MSSubClass, EnclosedPorch
